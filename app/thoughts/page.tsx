...
export default function ThoughtsPage() {
  const { data: posts, isLoading } = useSWR<Post[]>('/api/thoughts', fetcher, {
    ...
    <main className="min-h-screen bg-cream/50 pb-20 md:pb-0">
      ...
      <header className="pt-32 pb-16 px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-serif text-5xl md:text-6xl text-charcoal mb-4">思考</h1>
          <p className="font-mono text-sm text-charcoal/40 tracking-wider">THOUGHTS & ESSAYS</p>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          {posts.length === 0 && (
            <div className="text-center py-20 text-charcoal/40">
              <p className="font-serif text-xl">暂无思考文章</p>
              <p className="font-mono text-sm mt-2">thoughts directory is empty</p>
            </div>
          )}
        </div>
      </section>
